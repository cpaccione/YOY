              ...
              <div class="modal-content">
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="social-cta">
                        <h5>SHARE NOW TO SHOW YOUR SUPPORT &nbsp;<i class="fa fa-lg fa-facebook-square" aria-hidden="true"></i> &nbsp;<i class="fa fa-lg fa-twitter-square" aria-hidden="true"></i></h5>
                      </div>
                    </div>
                  </div>
                ...
                <div class="modal-footer">
                  <section class="social">
                    <p>Show your support for Alexia! <i class="fa fa-lg fa-facebook-square" aria-hidden="true"></i> <i class="fa fa-lg fa-twitter-square" aria-hidden="true"></i></p>
                  </section>
          ...
          <div id="modal-two" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg">
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <section class="social">
                    <p>Show your support for Raliyah! <i class="fa fa-lg fa-facebook-square" aria-hidden="true"></i> <i class="fa fa-lg fa-twitter-square" aria-hidden="true"></i></p>
                  </section>
                  <section class="white-break"></section>
                  <section class="modal-nav-container">
                    <ul class="modal-navigation">
        ...
        <div id="modal-three" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <section class="social">
                  <p>Show your support for Melanie! <i class="fa fa-lg fa-facebook-square" aria-hidden="true"></i> <i class="fa fa-lg fa-twitter-square" aria-hidden="true"></i></p>
                </section>
                <section class="white-break"></section>
                <section class="modal-nav-container">
                  <ul class="modal-navigation">
        ...
        <div id="modal-four" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <section class="social">
                  <p>Show your support for Abria! <i class="fa fa-lg fa-facebook-square" aria-hidden="true"></i> <i class="fa fa-lg fa-twitter-square" aria-hidden="true"></i></p>
                </section>
                <section class="white-break"></section>
                <section class="modal-nav-container">
                  <ul class="modal-navigation">
      ...
      <div id="modal-six" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <section class="social">
                  <p>Show your support for Jocelyn! <i class="fa fa-lg fa-facebook-square" aria-hidden="true"></i> <i class="fa fa-lg fa-twitter-square" aria-hidden="true"></i></p>
                </section>
                <section class="white-break"></section>
                <section class="modal-nav-container">
                  <ul class="modal-navigation">
